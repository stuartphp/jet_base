<div class="mt-8">
    <div class="text-2xl">
        <div>Product_Units</div> 
    </div>

    <div class="mt-6">
        <div class="flex justify-end">
            <x:tall-crud-generator::button mode="add" wire:click="$emitTo('product-units-child', 'showCreateForm');">Create New</x:tall-crud-generator::button>
        </div>
        <x:tall-crud-generator::table class="mt-4">
            ...
            @foreach($results as $result)
                <tr class="hover:bg-gray-300">
                    ...
                    <x:tall-crud-generator::table-column>
                        <x:tall-crud-generator::button mode="edit" wire:click="$emitTo('product-units-child', 'showEditForm',  {{ $result->id}});">Edit</x:tall-crud-generator::button>
                        <x:tall-crud-generator::button mode="delete" wire:click="$emitTo('product-units-child', 'showDeleteForm',  {{ $result->id}});">Delete</x:tall-crud-generator::button>
                    </x:tall-crud-generator::table-column>
               </tr>
            @endforeach
